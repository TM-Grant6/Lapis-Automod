...
function animateVaildate(packet, dbAccount, client) {
  if (config.animateChecks.animateCheck1 === true && (packet.action_id !== "row_left" && packet.action_id !== "row_right") && typeof packet.boat_rowing_time === 'number') {
  ...
  if (config.animateChecks.animateCheck2 === true && packet.action_id === "none") {
