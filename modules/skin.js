function skinVaildate(packet, dbAccount, client, packetType) {
	if (packetType === "playerList") {
		...
		if (packet.skin_data.full_skin_id != packet.skin_data.skin_id) {
			...
			client.sendCommand(`kick "${packet.xbox_user_id}" Invaild skin information sent. [T2] (List)`, 0)
		}
		...
		if (packet.skin_data.skin_data.width > 512 || packet.skin_data.skin_data.width < 64) {
			...
			client.sendCommand(`kick "${packet.xbox_user_id}" Invaild skin information sent. [T3] (List)`, 0)
		}
		...
		if (packet.skin_data.skin_data.height > 512 || packet.skin_data.skin_data.height < 64) {
			...
			client.sendCommand(`kick "${packet.xbox_user_id}" Invaild skin information sent. [T4] (List)`, 0)
		}
		...
		if (packet.skin_data.play_fab_id > 16 || packet.skin_data.play_fab_id < 16) {
			...
			client.sendCommand(`kick "${packet.xbox_user_id}" Invaild skin information sent. [T6] (List)`, 0)
		}
		...
		if (packet.skin_data.geometry_data_version.length < 5 || packet.skin_data.geometry_data_version.length > 6) {
			...
			client.sendCommand(`kick "${packet.xbox_user_id}" Invaild skin information sent. [T10] (List)`, 0)
		}
		...
		if (packet.skin.full_skin_id != packet.skin.skin_id) {
			...
			client.sendCommand(`kick "${dbAccount.xuid}" Invaild skin information sent. [T2] (Skin)`, 0)
		}
		...
		if (packet.skin.skin_data.width > 512 || packet.skin.skin_data.width < 64) {
			...
			client.sendCommand(`kick "${dbAccount.xuid}" Invaild skin information sent. [T3] (Skin)`, 0)
		}
		...
		if (packet.skin.skin_data.height > 512 || packet.skin.skin_data.height < 64) {
			...
			client.sendCommand(`kick "${dbAccount.xuid}" Invaild skin information sent. [T4] (Skin)`, 0)
		}
